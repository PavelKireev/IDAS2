...
@Component
public class HospitalizaceUpdateFormValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        @NotNull HospitalizaceUpdateForm form = (HospitalizaceUpdateForm) target;
        ...
        if (Objects.isNull(form.getHospitalizaceDo()) ||
            ...
            errors.rejectValue("hospitalizaceDo", "", "Datum do nesmi byt pozdeji nez datum od");
    }
}
