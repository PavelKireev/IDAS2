...
@Component
public class OrdinaceCreateFormValidator implements Validator {

    private final OrdinaceRepository ordinaceRepository;

    @Autowired
    public OrdinaceCreateFormValidator(
    ...
    public void validate(Object target, Errors errors) {
        @NotNull OrdinaceCreateForm form = (OrdinaceCreateForm) target;
